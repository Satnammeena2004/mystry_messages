...
export default function MystryMessageVerifyEmail({
        ...
        <Container style={container}>
          <Section style={coverSection}>
            <Section style={imageSection}>
              <Img
                src={`https://images.hiverhq.com/blog/wp-content/uploads/2016/06/tr:pr-true/119-Email-Phrases-to-Help-You-Get-the-Desired-Respons1e.png`}
                width="75"
                height="45"
                alt="AWS's Logo"
              />
            ...
            <Section style={upperSection}>
              ...
              <Text style={verifyText}>Email {email}</Text>
